import { r as reactExports, s as storage, j as jsxRuntimeExports, L as Label, I as Input, B as Button } from "./index-33rM45Gk.js";
const workflowSteps = [
  {
    label: "Onboarding",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-gray-800", children: step.label })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-0.5 leading-tight", children: step.desc })
            ] })
          ]
        }
      ),
...
function LoginPage({ onLogin }) {
  ...
  const [isAdminPortal, setIsAdminPortal] = reactExports.useState(
  ...
  const loginFormContent = /* @__PURE__ */ jsxRuntimeExports.jsx(FormWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm", children: [
    ...
    !isAdminPortal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
  ...
  const activeForm = view === "super-admin-setup" ? superAdminSetupContent : view === "owner-signup" ? ownerSignupContent : view === "forgot-password" ? forgotFormContent : view === "otp-verify" ? otpVerifyContent : view === "new-password" ? newPasswordContent : loginFormContent;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex flex-1 flex-col md:flex-row overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorkflowPanel, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                width: 2,
                background: "linear-gradient(to bottom, transparent, #c9a44c 15%, #c9a44c 85%, transparent)"
              }
            }
          ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "footer",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5 text-center", children: "Secure • Multi-tenant • Role-based access" })
            ]
          }
        )
      ]
