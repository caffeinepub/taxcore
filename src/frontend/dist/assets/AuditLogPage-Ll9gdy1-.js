import { r as reactExports, s as storage, o as onStorageChange, j as jsxRuntimeExports } from "./index-DZAeQoEb.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            style: { borderColor: "#c9a44c", minWidth: 130 },
            children: staffNames.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: n, children: n }, n))
          }
        )
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b", children: ["Time", "Staff", "Client", "Field Changed", "Change"].map(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            ...
            filteredLogs.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-2.5 px-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: entry.userId.slice(0, 6)
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", style: { color: "#6B1A2B" }, children: entry.clientName }) }),
