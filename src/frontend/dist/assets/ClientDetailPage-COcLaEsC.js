import { c as createLucideIcon, r as reactExports, T as useControllableState, j as jsxRuntimeExports, x as createContextScope, V as useId, H as Primitive, F as composeEventHandlers, P as Presence, W as cn, s as storage, Z as parseDDMMYYYY, _ as getHeadOfIncome, L as Label, I as Input, B as Button } from "./index-BxcdP4mH.js";
import { u as useDirection, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-Cj03bIuV.js";
import { c as createRovingFocusGroupScope, R as Root, I as Item } from "./index-bovP2p5U.js";
...
import { L as Lock } from "./lock-CtwSdWI2.js";
import { S as Save } from "./save-CFcJAWFf.js";
/**
    ...
    if (digits.length === 15) {
      ...
      if (derived) {
        setWorkForm((f) => ({
          ...
          filingStatus: f.filingStatus === "Pending" ? "Pending for E-verification" : f.filingStatus
        }));
        setFilingDateLocked(true);
        return;
      }
