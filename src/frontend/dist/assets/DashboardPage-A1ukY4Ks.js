import { c as createLucideIcon, r as reactExports, g as getDeadlineAlertClients, a as getEVerificationAlerts, o as onStorageChange, U as Users, C as CircleCheckBig, s as storage, j as jsxRuntimeExports, S as ShieldAlert, B as Button, b as getClientWork, d as getLatestDocStatus, u as ue, e as getLatestDoc, q as queueDueDateNotifications } from "./index-DZAeQoEb.js";
import { C as Card, a as CardContent, M as MessageSquare, b as CardHeader, c as CardTitle } from "./card-DCyPCT5t.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DJViW3LA.js";
import { T as TriangleAlert, I as InlineStatusCell } from "./InlineStatusCell-C7XYRmUg.js";
import { g as getTaxYears } from "./taxYears-JUInSDi_.js";
import "./index-CqyvUmSQ.js";
/**
...
function DashboardPage({ user }) {
  ...
  const [stats, setStats] = reactExports.useState(() => computeStats("All"));
  ...
  const greeting = user.role === "Staff" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold", style: { color: "#6B1A2B" }, children: [
          "Welcome, ",
          user.name
        ] }),
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-4 text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gray-200" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-lg", style: { color: "#16A34A" }, children: stats.filed }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500", children: "Filed" })
          ] })
        ] })
      ]
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-semibold", style: { color: "#6B1A2B" }, children: "Overview" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3", children: cards.map((card) => {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5", style: { color: card.color } })
              }
            )
          ] }) })
        },
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "w-5 h-5 text-red-600 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-red-700", children: "⚠ HIGH PRIORITY: E-Verification Deadline Approaching" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: highEVerifAlerts.map(({ client, work, daysToDeadline }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-600 mt-2 font-medium", children: "E-verification must be completed within 30 days of filing date." })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", style: { color: "#6B1A2B" }, children: "Recent Clients (last 10)" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-4 pb-4 pt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          ...
          stats.recentClients.map((client) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 font-medium text-xs", children: client.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 text-gray-500 text-xs font-mono", children: client.pan }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 text-xs", children: client.taxYear }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2", children: docHasEntry ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    InlineStatusCell,
                    {
                      value: docStatus,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    InlineStatusCell,
                    {
                      value: (work == null ? void 0 : work.status) || "Pending",
