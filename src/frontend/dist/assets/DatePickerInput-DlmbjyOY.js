import { c as createLucideIcon, a0 as React, r as reactExports, j as jsxRuntimeExports, W as cn, a1 as buttonVariants, B as Button$1, T as useControllableState, x as createContextScope, V as useId, A as useComposedRefs, H as Primitive, F as composeEventHandlers, P as Presence, z as Portal$1, G as hideOthers, R as ReactRemoveScroll, M as createSlot, K as useFocusGuards, N as FocusScope, O as DismissableLayer, I as Input } from "./index-B7R9DoC4.js";
import { i as ChevronDown, f as createPopperScope, R as Root2$1, A as Anchor, C as Content, g as Arrow } from "./select-DSVQ4XEn.js";
/**
...
function DatePickerInput({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex gap-1 ${className}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { open: calOpen, onOpenChange: setCalOpen, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverContent, { className: "w-auto p-0", align: "end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Calendar,
        {
          ...
          disabled: maxDate ? (date) => date > maxDate : void 0,
          initialFocus: true
        }
      ) })
    ] })
