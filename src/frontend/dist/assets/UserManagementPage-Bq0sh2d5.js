import { c as createLucideIcon, r as reactExports, s as storage, j as jsxRuntimeExports, B as Button, D as Dialog, l as DialogContent, m as DialogHeader, n as DialogTitle, L as Label, I as Input } from "./index-DZAeQoEb.js";
...
function UserManagementPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "w-4 h-4", style: { color: "#C9A44C" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm", style: { color: "#6B1A2B" }, children: "Owner Account" })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-sm", style: { color: "#6B1A2B" }, children: [
        "Staff Members (",
        staffUsers.length,
        ")"
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { style: { background: "#6B1A2B" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: ["Name", "Email", "Mobile", "Role", "Actions"].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "th",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showForm, onOpenChange: setShowForm, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", "data-ocid": "user-management.dialog", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { style: { color: "#6B1A2B" }, children: "Add Staff User" }) }),
