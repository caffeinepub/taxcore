import { c as createLucideIcon, r as reactExports, M as useControllableState, j as jsxRuntimeExports, t as createContextScope, N as useId, A as Primitive, y as composeEventHandlers, P as Presence, O as cn, s as storage, T as parseDDMMYYYY, L as Label, I as Input, B as Button } from "./index-DZAeQoEb.js";
import { u as useDirection, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DJViW3LA.js";
import { c as createRovingFocusGroupScope, R as Root, I as Item } from "./index-CqyvUmSQ.js";
import { D as DatePickerInput } from "./DatePickerInput-l71_tFeC.js";
import { P as Plus } from "./plus-BQN9PTYR.js";
import { T as Trash2 } from "./trash-2-Cj29I8kl.js";
import { S as Save } from "./save-CdJNzAG6.js";
/**
...
function getHeadOfIncome(client) {
  if (client.headOfIncome) return client.headOfIncome;
  const legacy = client.sourceOfIncome;
...
function ClientDetailPage({ client, onBack }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg border p-4 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs", children: "Mobile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: client.mobile })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs", children: "Email" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm", children: client.email || "-" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs", children: "Category" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: client.clientCategory })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs", children: "Head of Income" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: headOfIncome })
      ] }),
      headOfIncome === "Business" && client.businessName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs", children: "Business Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: client.businessName })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-xs", children: "Due Date" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: client.dueDate })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "documents", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { style: { background: "rgba(107,26,43,0.1)" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "documents", className: "mt-4 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg border p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-3", style: { color: "#6B1A2B" }, children: "Add Document Entry" }),
                ...
                Select,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Gmail", children: "Gmail" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-lg border overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { style: { background: "#6B1A2B" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: ["Date", "Mode", "Status", "Remarks", "Action"].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "th",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "work", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg border p-5 max-w-lg space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold", style: { color: "#6B1A2B" }, children: "Work Processing" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
